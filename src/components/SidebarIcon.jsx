    ...
    const icons = [
        (
            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path
                    className={`fill-current ${ isSelected ? 'text-indigo-500' : 'text-slate-400' }`}
                    d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                />
                <path
                    className={`fill-current ${ isSelected ? 'text-indigo-600' : 'text-slate-600' }`}
                    d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                />
                <path
                    className={`fill-current ${ isSelected ? 'text-indigo-200' : 'text-slate-400' }`}
        ...
        (
            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path
                    className={`fill-current ${ isSelected ? 'text-indigo-300' : 'text-slate-400'}`}
                    d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                />
                <path
                    className={`fill-current ${ isSelected ? 'text-indigo-600' : 'text-slate-700'}`}
        ...
        (
            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                ...
                />
                <path
                    className={`fill-current ${ isSelected ? 'text-indigo-500' : 'text-slate-700'}`}
        ...
        (
            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path className={`fill-current ${ isSelected ? 'text-indigo-500' : 'text-slate-600'}`} d="M1 3h22v20H1z" />
                <path
                    className={`fill-current ${ isSelected ? 'text-indigo-300' : 'text-slate-400'}`}
